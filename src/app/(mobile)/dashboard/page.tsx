            ...
            <div className="px-5 space-y-8">
                ...
                <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Link href="/input">
                            <div className="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] active:scale-[0.96] transition-all">
                                <div className="flex flex-col items-center gap-3 text-center">
                                    <div className="w-24 h-24 bg-transparent flex items-center justify-center">
                                        <svg viewBox="0 0 24 24" fill="none" className="w-24 h-24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div>
                                        <p className="font-bold text-zinc-600 text-lg">Input</p>
                                    </div>
                                </div>
                            </div>
                        </Link>
                        ...
                        <Link href="/riwayat">
                            <div className="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] active:scale-[0.96] transition-all">
                                <div className="flex flex-col items-center gap-3 text-center">
                                    ...
                                    <div>
                                        <p className="font-bold text-zinc-600 text-lg">Riwayat</p>
                                    </div>
                                </div>
                            </div>
                        </Link>
                        ...
                        <Link href="/bantuan">
                            <div className="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] active:scale-[0.96] transition-all">
                                <div className="flex flex-col items-center gap-3 text-center">
                                    ...
                                    <div>
                                        <p className="font-bold text-zinc-600 text-lg">Bantuan</p>
                                    </div>
                                </div>
                            </div>
                        </Link>

                        <div className="bg-white/60 rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.02)] opacity-60">
                            <div className="flex flex-col items-center gap-3 text-center">
                                <div className="w-24 h-24 bg-transparent flex items-center justify-center">
                                    <svg viewBox="0 0 24 24" fill="none" className="w-24 h-24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div>
                                    <p className="font-bold text-zinc-600 text-lg">Profil</p>
                                </div>
                            </div>
                        </div>
                    </div>
